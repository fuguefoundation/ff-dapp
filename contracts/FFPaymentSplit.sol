...
contract FFPaymentSplit is Context {
    ...
    function() external payable {
        ...
        if (_msgSender() != address(_ffKudosInterface)) {
            ...
            emit DonationReceived(newDonationId, _msgSender(), msg.value, data);
    ...
    function terminate() public onlyAdmin {
        selfdestruct(address(_msgSender()));
    }
